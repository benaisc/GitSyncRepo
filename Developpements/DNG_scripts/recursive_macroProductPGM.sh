...
# destination directory which will contain developped raw images (pgm)
...
macroProductPGM () {
    ...
    shopt -s globstar # allow globbing
    current_dir=''
    cpt=0
    ...
    for filename in $rawDir/**/*; do # iterate recursively over given dir
	    ...
	    i=${filename##*/} # file name without path
